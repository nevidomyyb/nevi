...
class WPPChatAnalysis(BasePage):
    ...
    def draw(self):
        ...
        From there I began to study the specifics of this area and realized that in addition to being something very technical, it is also a very theoretical area based on statistics and a lot of mathematics, I would even say that it's from a certain point of view, philosophical.
        ...
        The aim of the project was to create an application that would run a pipeline to clean and transform a text file that Whatsapp makes available from group conversations, and with this generate some metrics and information, such as the average number of words sent by each member of the group, the word cloud and the most sent words or phrases.
        """)        
        
        st.markdown("""
        ### The progress of the project
        
        The information cleaning and extraction stage was not complicated, just Pandas/Polars to work with the raw data. As a result, I got the metrics I was looking for, the most used words, the most common n-grams for each member of the group, a word cloud and graphs to visualize this information, done in Streamlit.
        ...
        Although I didn't dive into NLP, I had to use the concepts I'd learned about language processing and N-gram theory to be able to clean up properly for the next steps.
